...
const CoinArea = () => {
    ...
    const inputHandler = (event) => {
        ...
        if (value === "") { //Si el campo queda vacio...
            ...
            <form onSubmit={searchHandler} className=' mb-6 relative z-50'>
                <div className=' relative group'>
                    ...
                    <div className=' relative flex items-center'>
                        <input type="text" placeholder='Buscar criptomomenda' value={input} onChange={inputHandler} required
                        ...
                        <button type='submit' className=' z-10 relative right-2 top-1/2 -translate-x-1/2 px-4
                ...
                {filteredCoins.length > 0 && (
                    <ul className='absolute top-full left-0 w-full bg-gray-800/95 border border-gray-700 mt-2 rounded-lg
